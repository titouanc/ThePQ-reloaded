...
retire de la liste des FD gérés (il n'est donc plus disponible pour lecture) et émet un message ("type": 
"DISCONNECT", "client_id": <id>) dans la queue de sortie. 
...
l'objet, une socket en listen est créée. Lors de chaque nouvelle connection, un message ("type": "CONNECT", 
"client_id": <id>) est émis dans la queue d'entrée.
