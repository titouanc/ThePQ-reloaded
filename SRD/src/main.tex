...
\newglossaryentry{sponsor}{
    name=sponsor,
    description={Mécène qui accepte de financer une \gls{equipe} sous certaines conditions}
}
...
\newglossaryentry{entrainement}{
	name=entrainement,
	description={Action déclenchée par l'\gls{utilisateur} permettant d'améliorer les \gls{aptitude}s des joueurs. Un entrainement est divisé en groupes d'entrainements, spécifiés par l'\gls{utilisateur}. Lancer un entrainement entraine une augmentation de la fatigue des joueurs}
}
\newglossaryentry{groupe d'entrainement}{
	name={groupe d'entrainement},
...
\hline
1.6 & Mircea & 20/02/2014 & Commentaire Diagramme Activite Player Market\\
\end{tabular}
\end{figure}
...
\input{launchusecase.tex}
\input{gestionusecase.tex}
\input{championnatusecase.tex}
\input{gameusecase.tex}

\section{Exigences non fonctionnelles}

\input{utilisateur-exigences.tex}

\section{Exigences de domaine}
\input{utilisateur-domaine.tex}
...
\input{serverusecase.tex}
\input{DescriptionUseCaseChampionshipServer.tex}

\section{Exigences non fonctionnelles}
\input{systeme-exigences.tex}

\section{Design et fonctionnement du système}
\input{systeme-design.tex}
\input{terrain.tex}

\appendix
\section*{À propos de la librairie graphique}
\input{gui.tex}
